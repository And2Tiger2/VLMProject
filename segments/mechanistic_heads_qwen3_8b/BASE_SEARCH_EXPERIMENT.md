...
A passive attention ranking is evidence of routing, not causality. A head set should be described as search-causal only if its locked-set ablation harm exceeds both controls and the intact base model performs above four-way chance.
