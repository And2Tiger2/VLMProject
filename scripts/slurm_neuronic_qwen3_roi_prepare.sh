...
ROI_ROOT="${ROI_ROOT:-segments/vlm_bias_attention/data/vlmbias_roi_masks_v1}"
VLMBIAS_DATASET="${VLMBIAS_DATASET:-segments/vlm_bias_attention/data/vlmbias_400.jsonl}"
...
uv run python scripts/prepare_qwen3_roi_attention_experiment.py "$STAGE" \
