...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a unified VLMBias two-pass prompt experiment.")
    parser.add_argument("--dataset", default="data/vlmbias_400.jsonl")
    parser.add_argument("--out-dir", default="runs/vlmbias_two_pass_unified")
    ...
    parser.add_argument(
        ...
        default=["original"],
        help="Use `original` for the corrected first-experiment structure. Add `image_aware` only to reproduce the later prompt-policy factor.",
    )
    parser.add_argument(
        "--answer-modes",
        nargs="+",
