...
RUN_ROOT="${RUN_ROOT:-segments/vlm_bias_attention/runs/qwen3_high_bias_roi_attention_v1}"
...
srun uv run python scripts/run_qwen3_roi_attention_condition.py \
